...
def print_help_info():
  print('\nUsage: fig4seismo2d.py [-h] | [-i inputpath]' +
    ' [-o outputpath] [-c fileFDconf] [-S srcsta] [-d stride] [-s scalefactor]')
  ...
  print('  [srcsta   ]: station name of the virtrual source')
...
#====================================================================================   
try:
  opts, args = getopt.getopt(sys.argv[1:], 'hl:i:o:c:S:d:s:', ['help',
    'inputpath=', 'outputpath=', 'fileFDconf=',
    'srcsta', 'stride=', 'scalefactor='])
