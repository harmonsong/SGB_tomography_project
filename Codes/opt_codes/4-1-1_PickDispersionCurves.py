...
class DispersionSpectrum():
    ...
    def search(self):
        ...
        inon = np.array(inon)
        inon = inon.reshape(self.nc,self.nf)
...
if __name__ == '__main__':
    ...
    for i in range(len(key_ds)):
        filepath = info_basic['dir_ds']+'/ds_'+key_ds[i]+'.h5'
        outfile = info_basic['dir_ds']+"config_"+key_ds[i]+".yml"
