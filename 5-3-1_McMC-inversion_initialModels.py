...
dir_file = dir_inv_McMC + 'initial/'
dir_image = dir_project + info_basic['rdir_image'] + 'initial_model/'
dir_inv = dir_inv_McMC + 'inversion/'
if os.path.exists(dir_image) == False:
    os.makedirs(dir_image)
if os.path.exists(dir_inv_McMC) == False:
...
outname_config = dir_inv + 'config_McMC.ini'
if os.path.exists(outname_config)==False:
    shutil.copyfile('config_McMC.ini', dir_inv_McMC+'config_McMC.ini')
